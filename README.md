...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/bunq-sdk-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14187&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bunq-sdk-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `bunq-sdk` can be installed with:

```
conda install bunq-sdk
```

It is possible to list all of the versions of `bunq-sdk` available on your platform with:
